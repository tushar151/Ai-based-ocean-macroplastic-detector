...
# Load YOLO model
model_path = "C:/Users/TUSHAR SETHI/Desktop/best (1).pt"  # Update your model path
...
# st.markdown(
#     """
#     <div class='footer' style='font-size: 20px; font-weight: bold; text-align: center; 
#     background: linear-gradient(90deg, #ff9a9e, #fad0c4, #fad0c4, #fbc2eb, #a6c1ee); 
#     -webkit-background-clip: text; color: transparent; padding: 10px;'>
#     💡 This app uses a <span style="color:#e74c3c;">YOLOv8</span> model to identify 
#     <span style="color:yellow;">plastic waste</span> in the ocean. 🌊 Save our 
#     <span style="color:#3498db;">blue planet</span>! 💙🐠
#     </div>
#     """,
#     unsafe_allow_html=True
# )
